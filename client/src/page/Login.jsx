...
const Login = () => {
    return (
        <div>
            <div className="flex flex-col max-w-md p-6 rounded-md sm:p-10 dark:bg-gray-50 dark:text-gray-800 border shadow">
                ...
                <form noValidate="" action="" className="space-y-12">
                    ...
                    <div className="space-y-2">
                        <div>
                            <button type="button" className="btn w-full px-8 py-3 font-semibold rounded-md dark:bg-violet-600 dark:text-gray-50">Login</button>
                        </div>
